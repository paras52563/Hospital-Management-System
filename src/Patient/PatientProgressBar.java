...
public class PatientProgressBar extends JFrame {
    private JProgressBar progressBar;
    private Timer timer;
    private int progress = 0;

    public PatientProgressBar() {
        setTitle("Loading Patient Portal...");
        setSize(500, 250);
        ...
        JLabel title = new JLabel("Patient Portal - Loading");
        ...
        timer = new Timer(35, (ActionEvent e) -> {
            ...
            if (progress >= 100) {
                timer.stop();
                dispose();
                new PatientLogin().setVisible(true); // <- Your patient login form
            }
        });
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new PatientProgressBar().setVisible(true));
    }
}
